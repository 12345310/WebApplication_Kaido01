...
using WebApplication_Kaido01.Models;

namespace WebApplication_Kaido01.Controllers
{
    public class MembersController : Controller
    {
        private WebApplication_Kaido01Context db = new WebApplication_Kaido01Context();
